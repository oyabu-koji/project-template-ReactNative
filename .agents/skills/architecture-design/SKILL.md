...
description: docs/product-requirements.mdとdocs/functional-design.mdからdocs/architecture.mdを作成・更新する。React Native・Expo・JavaScriptの技術選定、責務境界、データ管理、品質特性、依存方針を定義する場合に明示的に使用する。機能要件の追加、リポジトリ配置、コード実装には使用しない。
---
...
6. 明示依頼なしにNode、Expo SDK、言語、managed workflowを変更しない。Expo関連依存は互換性方針を示す。
